...
export const useDrawing = (initialDuration = 8, initialBgColor = '#4D4DFF') => { // initialDuration — длительность звука, которую движок использует по умолчанию для новых мазков
